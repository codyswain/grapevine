...
class ProfileViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.view = styleButton(button: RulesButton, view: self.view, color1: #colorLiteral(red: 0.8705882353, green: 0.3803921569, blue: 0.6156862745, alpha: 1), color2: Constants.Colors.yellow)
        self.view = styleButton(button: ContactButton, view: self.view, color1: #colorLiteral(red: 0.8705882353, green: 0.3803921569, blue: 0.6156862745, alpha: 1), color2: Constants.Colors.yellow)
...
extension ProfileViewController: UITabBarDelegate {
    func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
        if item.tag == 0 {
            ...
            self.performSegue(withIdentifier: "profileToActivity", sender: self)
        } else {
            bottomNavBar.selectedItem = bottomNavBar.items?[2]
        }
    }
