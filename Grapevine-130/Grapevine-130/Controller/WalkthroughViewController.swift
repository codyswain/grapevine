...
//        cell.backgroundColor = indexPath.item % 2 == 0 ? .red : .green
        ...
        case 3:
            ...
            cell.descriptionTextView.attributedText = NSMutableAttributedString(string: "social app!", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 24),  NSAttributedString.Key.foregroundColor: UIColor.white])
            cell.descriptionTextView.textAlignment = .center
            cell.descriptionTextView.translatesAutoresizingMaskIntoConstraints = false
            cell.descriptionTextView.isEditable = false
            cell.descriptionTextView.isSelectable = false
