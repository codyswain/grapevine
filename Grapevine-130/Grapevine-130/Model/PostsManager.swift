...
struct PostsManager {
    ...
    */
    ...
    - Parameter interaction: The interaction value to be sent
        ...
        - 4: flag
     */
    func performInteractionRequest(interaction: Int, docID: String, poster: String) {
        let endpoint = Constants.serverURL + "interactions/?"
        let urlString = "\(endpoint)&user=\(Constants.userID)&post=\(docID)&action=\(interaction)&poster=\(poster)"
